...
<div class="con-login">
  <form method="post" name="frm-add" id="frm-add" autocomplete="off" action="<?=$_SERVER['PHP_SELF'];?>">
    <table width="460" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="50" colspan="6" align="center"><h1><span class="cl-green">เพิ่มข้อมูลลูกค้า</span></h1></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="10" height="40">&nbsp;</td>
        <td height="40" colspan="2" align="left"><p> <strong>
          <label>
      ...
      <tr>
        ...
        <td width="150" height="60" align="center"><input name="submit" type="submit" class="btn" id="submit" form="frm-add" value="Save"  onClick="return  check_regis();"></td>
	  ...
	  if($row_check_user  ==  true)
	 ...
	 else
	    {
			...
			if($result_regis  == true)
			  {
				  echo  "<script>alert('Save succeed full');window.location='add-member.php?link=uri_user';</script>";  
			  }
		}
...
function  check_regis()
   {
		...
		else if(data4.checked  ==  false  &&  data5.checked  ==  false)
		   {
			   alert('เลือก  เพศ');
			   data4.focus();
			   return  false;
