	...
	?>
      <table width="460" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td height="50" align="center">&nbsp;</td>
          <td height="50" align="center"><input type="button" name="button" id="button" value="ย้อนกลับ" onClick="window.location='show-spe.php';" ></td>
        </tr>
      </table>
    </div>
  <br>
	<div class="show">
   	  <table width="1000" border="0" cellspacing="0" cellpadding="0">
    	  <tr>
    	    ...
    	    <th width="320" height="40" align="left">ชื่อสินค้า</th>
    	    <th width="220" align="left">กลุ่มสิ้นค้า</th>
    	    <th width="150" align="left">ราคาเดิม</th>
    	    <th width="150" height="40" align="left">ราคาที่จัดโปร</th>
   	    </tr>
		...
		?>
    	  <tr>
    	    ...
    	    <td width="320" height="70" align="left"><?=$show['pro_name'];?></td>
    	    <td width="220" height="70" align="left"><?=$show['group_name'];?></td>
    	    <td width="150" height="70" align="left"><?=$show['pro_sell'];?></td>
    	    <td width="150" height="70" align="left"><?=$show['spe_price'];?></td>
   	    </tr>
        <?php
						}
		?>
