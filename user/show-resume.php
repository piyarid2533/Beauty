...
?>
  <div class="page-header">
	...
	<div class="show">
        ...
        <?php
		include('../config.php');
        $sql_show   =  "select count(DATE_FORMAT(book_date , '%Y-%m')) as  num_count , book_date  , DATE_FORMAT(book_date , '%Y-%m')  as  id_date   FROM books  where  book_date  like  '".$find_date."%' and  member_user = '".$_SESSION['se_id']."'    group by  DATE_FORMAT(book_date , '%Y-%m')   order by  book_date   DESC";
		...
		?>
    	  <tr>
    	    ...
    	    <td width="120" height="35" align="left"><a href="detail-resume.php?say_date=<?=$show['id_date']?>"><img src="../img/Search.png" width="24" height="24"  alt=""/></a></td>
   	    </tr>
        <?php
				}
		?>
