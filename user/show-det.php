	...
	<div class="show">
   	  <table width="1000" border="0" cellspacing="0" cellpadding="0">
    	  <tr>
    	    ...
    	    <th width="135" height="40" align="left" bgcolor="#F5F5F5">รายการการจอง</th>
   	    </tr>
        <?php
        include('../config.php');
		...
		?>
    	  <tr >
    	    ...
    	    <td width="135" height="35" align="center"><a href="detail-det.php?link=uri_det&say_id=<?=$show['new_id'];?>"><img src="../img/Search.png"  alt="" width="24" height="24"/></a></td>
   	    </tr>
        <?php
				}
		?>
        <tr>
    	    <td height="100" colspan="7" align="center" class="cl-orange"><h3>กรุณาจองรายการก่อน</h3></td>
   	    </tr>
  	  </table>
  </div>
</div>
